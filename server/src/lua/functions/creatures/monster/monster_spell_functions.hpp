...
private:
	...
	static int luaMonsterSpellSetCastText(lua_State* L);
	static int luaMonsterSpellSetPokemonMoveId(lua_State* L);
	static int luaMonsterSpellSetCastVisual(lua_State* L);
	...
	static int luaMonsterSpellSetPokemonCombat(lua_State* L);
