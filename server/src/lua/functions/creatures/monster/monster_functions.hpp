...
private:
	...
	static int luaMonsterSetPokemonCombatProfile(lua_State* L);
	static int luaMonsterSetPokemonPlayerControlled(lua_State* L);
	static int luaMonsterCastPokemonMove(lua_State* L);
