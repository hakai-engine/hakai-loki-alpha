...
---@param target Creature
---@return boolean|nil
function Monster:castPokemonMove(moveId, target) end
...
---@param arg10 number
---@return boolean|nil
function Monster:setPokemonCombatProfile(arg2, type1, type2, arg5, arg6, arg7, arg8, arg9, arg10) end

---@param value boolean
---@return boolean|nil
function Monster:setPokemonPlayerControlled(value) end
...
---@param text string
---@return boolean|nil
function MonsterSpell:setCastText(text) end
...
---@param length number
---@return boolean|nil
function MonsterSpell:setCastVisual(north, east, south, west, width, length) end
...
---@param pokemonType any
---@param pokemonMoveCategory any
---@param power number
---@return boolean|nil
function MonsterSpell:setPokemonCombat(pokemonType, pokemonMoveCategory, power) end

---@param moveId string
---@return boolean|nil
function MonsterSpell:setPokemonMoveId(moveId) end
