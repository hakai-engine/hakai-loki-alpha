...
function Player:onMoveItem(item, count, fromPosition, toPosition, fromCylinder, toCylinder)
	if item:getCustomAttribute("hakai.pokemon.instanceId") then
		self:sendCancelMessage("Captured Pokemon cannot be moved through Tibia containers. Use the Capture Bag.")
		return false
	end
