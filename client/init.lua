...
Services = {
    ...
    clientAssets = {
        -- Hakai ships no unverified executable/content auto-installer.
        -- Install the pinned 15.25 asset pack with the documented local tool.
        enabled = false,
...
g_app.setName("Hakai Engine Client Thor");
g_app.setCompactName("hakai-engine-client-thor");
g_app.setOrganizationName("hakai-engine");
